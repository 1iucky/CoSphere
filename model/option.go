...
func InitOptionMap() {
	...
	common.OptionMap["BadRequestRetryKeywords"] = operation_setting.BadRequestRetryKeywordsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "BadRequestRetryKeywords":
		operation_setting.BadRequestRetryKeywordsFromString(value)
